...
TelemetryLoRaConfig TelemetryTask::buildRadioConfig() const
{
...
#if defined(NURA_USE_SX127X_LORA)
    radioConfig.ssPin = BoardPinMap::SparkFunSx1276_1W::ssPin;
    radioConfig.resetPin = BoardPinMap::SparkFunSx1276_1W::resetPin;
    radioConfig.libraryResetPin = BoardPinMap::SparkFunSx1276_1W::libraryResetPin;
    radioConfig.dio0Pin = BoardPinMap::SparkFunSx1276_1W::dio0Pin;
    radioConfig.rxEnablePin = BoardPinMap::SparkFunSx1276_1W::rxEnablePin;
    radioConfig.txEnablePin = BoardPinMap::SparkFunSx1276_1W::txEnablePin;
    ...
    // TelemetryTask owns the bounded retry loop; keep one hardware probe per
    // attempt so a failed boot cannot multiply the retry count.
    radioConfig.initAttempts = 1U;
#endif
