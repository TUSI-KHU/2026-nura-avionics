...
struct StatusIndicator final
{
    ...
    static constexpr uint8_t led2Pin = LED_BUILTIN;
};

struct Buzzer final
{
    static constexpr uint8_t pin = kUnassignedPin;
};
...
struct BNO085 final
{
    ...
    static constexpr uint8_t sdaPin = I2c0Bus::sdaPin;
    static constexpr uint8_t sclPin = I2c0Bus::sclPin;
    static constexpr uint8_t i2cAddress = 0x4AU;
...
struct Pyro1 final
{
    static constexpr uint8_t gpio1Pin = 2U;
    static constexpr uint8_t gpio2Pin = kUnassignedPin;
    static constexpr uint8_t sensePin = kUnassignedPin;
};

struct Pyro2 final
{
    static constexpr uint8_t gpio1Pin = 3U;
    static constexpr uint8_t gpio2Pin = kUnassignedPin;
    static constexpr uint8_t sensePin = kUnassignedPin;
};
...
{
    static constexpr uint8_t voltagePin = kUnassignedPin;
