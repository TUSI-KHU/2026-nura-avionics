...
constexpr uint16_t kFlightLogStorageQueueBytes = 8U * 1024U;
constexpr uint32_t kFlightLogQspiFlashBytes = 16UL * 1024UL * 1024UL;
constexpr uint16_t kFlightLogQspiPageBytes = 256U;
constexpr uint16_t kFlightLogQspiEraseSectorBytes = 4U * 1024U;
constexpr uint8_t kFlightLogQspiEraseAheadSectors = 2U;
constexpr uint32_t kFlightLogQspiInitEraseTimeoutUs = 500000UL;
constexpr uint32_t kFlightLogQspiProgramTimeoutUs = 10000UL;
constexpr uint32_t kFlightLogQspiIpCommandTimeoutUs = 1000UL;
constexpr uint32_t kFlightLogSdPreallocateBytes = 16UL * 1024UL * 1024UL;
constexpr uint16_t kFlightLogSdSectorBytes = 512U;
constexpr uint32_t kFlightLogSdBusyTimeoutMs = 1200UL;
...
constexpr uint8_t kFlightStateTransitionQueueDepth = 16U;
} // namespace Logger
...
constexpr uint8_t kCalibrationSamples = 64U;
constexpr uint8_t kCalibrationSampleDelayMs = 5U;
constexpr float kCalibrationMinNormG = 0.25f;
constexpr float kCalibrationMaxNormG = 8.0f;
...
namespace BMP180
{
constexpr uint8_t kI2cAddress = 0x77U;
constexpr uint8_t kOversampling = 0U; // OSS0 keeps pressure conversion inside the 50 ms barometer task budget.
constexpr uint16_t kTemperatureConversionDelayMs = 5U;
constexpr uint16_t kPressureConversionDelayMs = 5U;
constexpr uint16_t kConversionTimeoutMs = 50U;
constexpr uint8_t kTemperatureRefreshPressureSamples = 20U;
constexpr float kMinDatasheetPressurePa = 30000.0f;
constexpr float kMaxDatasheetPressurePa = 110000.0f;
} // namespace BMP180
